...
Use os defaults declarados no schema somente para informações neutras. Nunca presuma nomes, IDs, valores, datas, faixa etária ou outros dados pessoais. Todo convidado pertence ao casal; família ou grupo são apenas formas de organização e envio do convite.
...
const actionDescriptions: Record<WeddingActionName, string> = {
  ...
  add_guest: 'Cadastrar uma pessoa na lista de convidados do casal. Exige nome e faixa etária. Família ou grupo são opcionais para organização do convite.',
